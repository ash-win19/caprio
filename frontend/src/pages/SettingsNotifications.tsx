...
export default function SettingsNotifications() {
  return <Page>
    ...
    <PageBody width="form">
      ...
      <ol className="mt-5 list-decimal space-y-4 pl-5 text-sm leading-6 text-muted-foreground"><li>Open Plan and describe your tasks, commitments, and available time.</li><li>Check the proposed tasks and their estimates, then confirm your plan.</li><li>When something changes, use Adjust plan on Today to request a revision.</li></ol>
      <p className="mt-5 text-sm leading-6 text-muted-foreground">Changes are saved after you confirm them. Saved planning-time preferences do not schedule reminders.</p>
