...
-- One agent call within the turn; tool calls from an earlier attempt are refused.
ALTER TABLE daily_plans ADD COLUMN turn_attempt_id UUID;
...
-- +goose Down
ALTER TABLE daily_plans DROP COLUMN turn_attempt_id;
